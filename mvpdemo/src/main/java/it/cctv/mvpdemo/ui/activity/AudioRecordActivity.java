...
import it.cctv.mvpdemo.event.EventBusConfig;
import it.cctv.mvpdemo.event.MainThreadEvent;
import it.cctv.mvpdemo.gloable.MyApp;
import it.cctv.mvpdemo.ui.manager.EnterRecordAudioEntity;
import it.cctv.mvpdemo.ui.view.LineWaveVoiceView;
import it.cctv.mvpdemo.ui.view.RecordAudioView;
import it.cctv.mvpdemo.utils.Cons;
import it.cctv.mvpdemo.utils.PaoPaoTips;
import it.cctv.mvpdemo.utils.PermissionUtil;
import it.cctv.mvpdemo.utils.StringUtil;
...
public class AudioRecordActivity extends FragmentActivity implements
    ...
    public String onRecordStart() {
        ...
        audioFileName = MyApp.getContext().getExternalCacheDir()+ File.separator + createAudioName();
